...
const AskedQuestion = () => {
    return (
        <div className='max-w-[1062px] mx-auto my-24'>
            <h1 className='font-extrabold text-[40px] text-secondary text-center'>Frequently Asked Question (FAQ)</h1>
            <p className='font-normal text-[16px] text-[#606060] text-center mt-6'>Enhance posture, mobility, and well-being effortlessly with Posture Pro. Achieve proper alignment, reduce <br /> pain, and strengthen your body with ease!</p>
            <div className='mt-10'>
