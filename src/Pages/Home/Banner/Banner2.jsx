    ...
    return (
         <div className='flex items-center bg-[#ffffff] p-20 rounded-2xl mt-8 max-h-[590px]'>
                    <div className='flex flex-col justify-self-start items-start'>
                        ...
                        <h1 className='font-extrabold text-[84px] text-secondary text-start'>Fastest  <br /> <span className='text-[#acc857]'>Delivery </span> & Easy <br /> <span className='text-[#acc857]'>Pickup</span></h1>
