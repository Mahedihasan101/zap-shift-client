...
const Banner1 = () => {
    return (
        <div className='flex   bg-[#ffffff] p-20 rounded-2xl mt-8 max-h-[590px]'>
            <div className='flex flex-col justify-self-start items-start'>
                <img src={bannerimg} alt="" className='max-w-[220px]' />
                <h1 className='font-extrabold text-[56px] text-secondary text-start'>We Make Sure Your<br /><span className='text-[#acc857]'>Parcel Arrives</span>On Time<br />- No Fuss.</h1>
